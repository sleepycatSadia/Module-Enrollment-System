            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <br><p class="notice" style="padding:10px; background-color: #006dd3;margin-left: 45px;font-size:18px;color:white">You can not book more than one section of same module.If you need to change section,first cancel your booking of your current section. Then book a new section.</p>                  
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            Section Name: &nbsp;<b>'.substr($title,0,40).'</b><br>
                            Module name&nbsp; : <b>'.substr($docname,0,40).'</b><br><br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="modules.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
