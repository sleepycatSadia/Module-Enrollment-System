...
<head>
    ...
    <title>Module and Section Detail</title>
    <style>
        .popup{
                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Module name or Scheduled Date (YYYY-MM-DD)" list="doctors" >&nbsp;&nbsp;
