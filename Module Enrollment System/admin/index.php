    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-dashbord">
                        <a href="modules.php" class="non-style-link-menu "><div><p class="menu-text">Modules</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="modules.php" method="post" class="header-search">
        
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Module name or Coure Title" list="doctors">&nbsp;&nbsp;
