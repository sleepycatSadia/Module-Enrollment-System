    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-dashbord">
                        <a href="modules.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Modules</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Enrollment Details</p>
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <form action="" method="post">
                            ...
                            <input  name="sheduledate" id="date" class="input-text filter-container-items" style="margin: 0;width: 95%;" placeholder="Enter date in this format 2022-11-05 ">
                        ...
                        <select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose Module Name from the list</option><br/>
                   ...
                   <td colspan="4">
                       <center>
                        ...
                        <tr>
                                ...
                                <th class="table-headin" onclick="sortTable(2)">
                                ...
                                <th class="table-headin"  onclick="sortTable(3)">
                                    
                                    Class Date & Time
                                    
                                </th>
                                
                                <th class="table-headin" onclick="sortTable(4)">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="appointment.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Registrations &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
